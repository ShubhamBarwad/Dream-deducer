...
function Dream() {
    const genAi = new GoogleGenerativeAI('AIzaSyCVgJkeGVjDVrI61EVHpQqiScx3fZNR3mw');
        ...
        <>
            <div className='max-w-96 mx-auto flex flex-col gap-5 my-3'>
                <label className='text required'>
                    ...
                    <textarea className='form-input' name='dream' placeholder="Tell me about your dream..." rows={5} required ref={refDream} />
                </label>
                ...
                <button className='btn btn-primary' onClick={() => analyseDream(refDream.current?.value)}>Find what my dreams mean</button>
            </div>
            {
                analysis.length && (
